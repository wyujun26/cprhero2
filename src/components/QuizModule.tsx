...
const allQuestions: Question[] = [
  // Batch 1: Q1-10 (Danger + Response)
  {
    ...
    correctAnswer: 1,
    explanation: "Always check that the scene is safe first to protect yourself from becoming a second casualty."
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation: "Checking for danger protects you from becoming a second casualty, which would make the situation worse."
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation: "Environmental hazards like traffic, electrical wires, fire, or toxic fumes are dangers you must check for."
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation: "If unsafe, call out from a safe distance and immediately call 995 for professional help."
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation: "Your safety is always the first priority. Assess the scene for hazards before approaching."
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation: "Tap the shoulders firmly and shout 'Are you OK?' to check for response without causing harm."
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation: "Tap the shoulders as it's safe and effective for checking response without risking injury."
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation: "No response indicates the person may be unconscious and requires immediate emergency care."
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation: "Shout 'Hello, hello! Are you OK?' clearly and loudly to check for response."
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation: "Tapping shoulders avoids potentially worsening a spinal injury that shaking could cause."
  },

  // Batch 2: Q11-20 (Shout + AED)
  {
    id: 11,
    question: "What number do you call for an ambulance in Singapore?",
    options: ["999", "911", "995", "112"],
    correctAnswer: 2,
    explanation: "In Singapore, 995 is the emergency number for ambulance and fire services."
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation: "Stay on the line so the dispatcher can provide instructions and gather important information."
  },
  {
    id: 13,
    ...
    correctAnswer: 1,
    explanation: "Pointing to a specific person ensures someone takes responsibility and calls for help."
  },
  {
    id: 14,
    ...
    correctAnswer: 1,
    explanation: "Assigning a specific person prevents the bystander effect where everyone assumes someone else will help."
  },
  {
    id: 15,
    ...
    correctAnswer: 1,
    explanation: "When alone, call 995 first (use speakerphone if possible) then immediately begin CPR."
  },
  {
    id: 16,
    ...
    correctAnswer: 1,
    explanation: "AED stands for Automated External Defibrillator - a device that delivers electric shocks to restore heart rhythm."
  },
  {
    id: 17,
    ...
    correctAnswer: 1,
    explanation: "Never leave the casualty alone. Send someone else to get the AED while you continue CPR."
  },
  {
    id: 18,
    ...
    correctAnswer: 1,
    explanation: "An AED analyzes the heart rhythm and delivers an electric shock if needed to restore normal rhythm."
  },
  {
    id: 19,
    ...
    correctAnswer: 2,
    explanation: "AEDs are widely available in public places like malls, MRT stations, community centres, and public buildings."
  },
  {
    id: 20,
    ...
    correctAnswer: 1,
    explanation: "Attach AED pads as soon as it arrives, minimizing interruption to CPR for the best chance of survival."
  },

  // Batch 3: Q21-30 (Breathing + Compressions part 1)
  {
    id: 21,
    ...
    correctAnswer: 1,
    explanation: "Check for breathing for no more than 10 seconds - every second counts in an emergency."
  },
  {
    id: 22,
    ...
    correctAnswer: 1,
    explanation: "Look for the rise and fall of the chest to determine if the person is breathing normally."
  },
  {
    id: 23,
    ...
    correctAnswer: 1,
    explanation: "Gasping (agonal breathing) is not normal breathing and indicates cardiac arrest - begin CPR immediately."
  },
  {
    id: 24,
    ...
    correctAnswer: 1,
    explanation: "If breathing normally, place them in the recovery position and continue monitoring while waiting for help."
  },
  {
    id: 25,
    ...
    correctAnswer: 1,
    explanation: "Every second without CPR reduces survival chances - brain damage can begin after 4-6 minutes without oxygen."
  },
  {
    id: 26,
    ...
    correctAnswer: 2,
    explanation: "Compressions should be performed at 100-120 per minute - similar to the beat of 'Stayin' Alive'."
  },
  {
    id: 27,
    ...
    correctAnswer: 2,
    explanation: "Adult chest compressions should be 4-6 cm (about 2 inches) deep to effectively circulate blood."
  },
  {
    id: 28,
    ...
    correctAnswer: 1,
    explanation: "Place your hands on the lower half of the breastbone (sternum) for effective compressions."
  },
  {
    id: 29,
    ...
    correctAnswer: 2,
    explanation: "Place the heel of one hand on the chest, place your other hand on top, and interlock your fingers."
  },
  {
    id: 30,
    ...
    correctAnswer: 1,
    explanation: "Keep your arms straight and locked, using your body weight to compress effectively without tiring quickly."
  },

  // Batch 4: Q31-40 (Compressions part 2 + AED usage part 1)
  {
    id: 31,
    ...
    correctAnswer: 1,
    explanation: "Full chest recoil means allowing the chest to completely return to its normal position between compressions."
  },
  {
    id: 32,
    ...
    correctAnswer: 1,
    explanation: "Full chest recoil allows the heart to refill with blood between compressions, maximizing blood flow."
  },
  {
    id: 33,
    ...
    correctAnswer: 2,
    explanation: "Switch rescuers every 2 minutes or when tired to maintain effective compressions without interruption."
  },
  {
    id: 34,
    ...
    correctAnswer: 1,
    explanation: "Rib fractures can occur during CPR but are far less serious than death - continue compressions."
  },
  {
    id: 35,
    ...
    correctAnswer: 2,
    explanation: "Only stop CPR when the casualty recovers, professional help arrives, or you're physically unable to continue."
  },
  {
    id: 36,
    ...
    correctAnswer: 1,
    explanation: "Always turn on the AED first - it will then provide voice instructions for all subsequent steps."
  },
  {
    id: 37,
    ...
    correctAnswer: 1,
    explanation: "Place one pad on the upper right chest and one on the lower left side as shown in the diagrams on the pads."
  },
  {
    id: 38,
    ...
    correctAnswer: 1,
    explanation: "Everyone must step back and avoid touching the casualty during analysis to ensure accurate rhythm detection."
  },
  {
    id: 39,
    ...
    correctAnswer: 1,
    explanation: "Immediately resume CPR with chest compressions after a shock - don't waste time checking pulse."
  },
  {
    id: 40,
    ...
    correctAnswer: 2,
    explanation: "No shock advised means the rhythm isn't shockable - continue CPR to maintain blood flow."
  },

  // Batch 5: Q41-50 (AED usage part 2 + General)
  {
    id: 41,
    ...
    correctAnswer: 1,
    explanation: "AEDs can be used on children - use pediatric pads if available, otherwise adult pads are acceptable."
  },
  {
    id: 42,
    ...
    correctAnswer: 1,
    explanation: "The chest must be dry for proper pad adhesion and to prevent electrical interference."
  },
  {
    id: 43,
    ...
    correctAnswer: 1,
    explanation: "Place pads at least 8cm (3 inches) away from pacemakers or implanted devices to avoid interference."
  },
  {
    id: 44,
    ...
    correctAnswer: 1,
    explanation: "AEDs are designed for untrained users and provide clear voice and visual instructions throughout."
  },
  {
    id: 45,
    ...
    correctAnswer: 1,
    explanation: "If pads are already attached, simply turn on the AED and follow its instructions - don't waste time replacing them."
  },
  {
    id: 46,
    ...
    correctAnswer: 1,
    explanation: "The correct sequence is: Danger, Response, Shout for help, AED, Breathing check, Compressions."
  },
  {
    id: 47,
    ...
    correctAnswer: 1,
    explanation: "After calling 995, immediately begin CPR - every second without compressions reduces survival chances."
  },
  {
    id: 48,
    ...
    correctAnswer: 1,
    explanation: "Hands-only CPR is recommended for all untrained bystanders - it's simpler and just as effective."
  },
  {
    id: 49,
    ...
    correctAnswer: 1,
    explanation: "Early CPR and defibrillation are the most critical factors - they can double or triple survival rates."
  },
  {
    id: 50,
    ...
    correctAnswer: 1,
    explanation: "Without CPR, the person will die. Any attempt at CPR gives them a chance - you cannot make it worse."
  }
];

const QuizModule: React.FC<QuizModuleProps> = ({ onBack, language, onChangeLanguage }) => {
  ...
  useEffect(() => {
    // Select 10 random questions from the 50-question bank
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <Award size={80} color="#FFD93D" style={{ margin: '0 auto 24px' }} />
          <h2 style={{
            fontSize: '32px',
            fontWeight: '800',
            color: '#333',
          ...
          <p style={{
            ...
            {percentage >= 70 
              ? "Excellent work! You're well-prepared to help in an emergency."
              : percentage >= 50
              ? "Good effort! Review the material and try again to improve."
              : "Keep learning! Practice makes perfect in life-saving skills."}
          </p>
